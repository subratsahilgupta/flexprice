...
func main() {
	...
	opts = append(opts,
		fx.Provide(
			...
			service.NewCustomerDashboardService,
		),
	)
...
func provideHandlers(
	...
	customerDashboardService service.CustomerDashboardService,
) api.Handlers {
	return api.Handlers{
		...
		CustomerDashboard:        v1.NewCustomerDashboardHandler(customerDashboardService, logger),
	}
}

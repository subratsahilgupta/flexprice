...
CREATE TABLE revenue_facts (
    ...
    usage_at_list_rate   NUMERIC(38,9) NOT NULL DEFAULT 0,
    tier_delta           NUMERIC(38,9) NOT NULL DEFAULT 0,
    entitlement_credit   NUMERIC(38,9) NOT NULL DEFAULT 0,
    ...
    billable_qty         NUMERIC(38,9) NOT NULL DEFAULT 0,

...
const (
	// Label holds the string label denoting the taxassociation type in the database.
	Label = "tax_association"
...
// Columns holds all SQL columns for taxassociation fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldStatus,

	...
	for i := range columns {
		...
		case invoicelineitem.FieldDescription:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ili.Description = new(string)
				*ili.Description = value.String
			}

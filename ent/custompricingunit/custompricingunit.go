...
const (
	// Label holds the string label denoting the custompricingunit type in the database.
	Label = "custom_pricing_unit"
	...
	EdgePrices = "prices"
	// Table holds the table name of the custompricingunit in the database.
	...
	PricesColumn = "custom_pricing_unit_id"
)

// Columns holds all SQL columns for custompricingunit fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldStatus,
...
// OrderOption defines the ordering options for the CustomPricingUnit queries.
